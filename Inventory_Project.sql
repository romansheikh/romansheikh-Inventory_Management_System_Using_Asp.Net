...
('Salim Sheikh', 01912200321, '02/01/1994', 'Male', '26, A, Lalbagh, Dhaka', 'salimbd@gmail.com', 'Dhaka'),
('Roman Sheikh', 01612200321, '04/10/1994', 'Male', '26, A, Mohammadpur, Dhaka', 'romansheikh3@gmail.com', 'Dhaka'),
('Jaman Sheikh', 01812200321, '07/12/1994', 'Male', '26, A, Hajarabagh, Dhaka', 'jamanbd@gmail.com', 'Dhaka'),
('Sahkil Sheikh', 01712200321, '03/09/1994','Male','26, A, Jhigatola, Dhaka', 'shakilbd@gmail.com', 'Dhaka')
Go
CREATE TABLE SupplierType
(
SupplierTypeID INT PRIMARY KEY IDENTITY,
SupplierTypeName varchar(20)
)
go
...
Create table Product
	(
		...
		SalesPrice Money,
		Supplier int references Suppliers(Supplierid),
...
insert into Product(CategoryID, ProductName, PurchasePrice, SalesPrice, Supplierid) values (1, 'Means Watch', 250.00, 400.00,1)
go
